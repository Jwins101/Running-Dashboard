...
const PLAN_DETAILS = {
  ...
  "2026-09-14": { longRun:"10 mi — easing back in, should feel recovered by now", tempo:"~4 mi total — 1mi warmup, 15 min @ 8:42–8:50/mi (recalibrated from actual 5K result: 7:57/mi), 1mi cooldown", easy:"2 runs, 4–5 mi, easy", note:"First week back to full volume after the race. Resume structured tempo work here." },
  "2026-09-21": { longRun:"13 mi — first time at goal distance, go slow, just finish", tempo:"~5 mi total — 1mi warmup, 25 min tempo @ 8:22–8:30/mi (recalibrated from actual 5K result), 1mi cooldown", easy:"2 runs, 4–5 mi, easy" },
